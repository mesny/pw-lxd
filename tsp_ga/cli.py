...
def parse_args() -> argparse.Namespace:
    ...
    reporting_group = parser.add_argument_group("Reporting and metadata")
    ...
    reporting_group.add_argument("--run-id", type=str, default="manual-run", help="Experiment run identifier")
    reporting_group.add_argument("--scenario-name", type=str, default="default", help="Human-readable experiment scenario name")
    reporting_group.add_argument("--metadata-containers-per-node", type=int, default=None, help="Metadata only: number of LXD containers per physical cluster node in this scenario")
    reporting_group.add_argument("--metadata-hostfile", type=str, default=None, help="Metadata only: MPI hostfile used for this run")
    reporting_group.add_argument("--metadata-cpu-limit", type=str, default=None, help="Metadata only: LXD CPU limit used per container")
    reporting_group.add_argument("--code-version", type=str, default=None, help="Code version, git commit, tag or manual version label, stored as metadata only")
