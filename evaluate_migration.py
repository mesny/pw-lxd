...
from evaluate_common import migration_criteria, write_outputs
...
def main() -> None:
    ...
    base = summary_path.parent / f"evaluate-quality-{args.run_group_id}"
    ...
    document = migration_criteria(summary_path, args.run_group_id)
